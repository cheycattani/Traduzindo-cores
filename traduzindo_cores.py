...
# Dicionário "cor"
cor ={'vermelho':'red', 'rosa': 'pink', 'preto': 'black', 'azul': 'blue', 'roxo': 'purple', 'amarelo': 'yellow', 'laranja': 'orange', 'azul escuro': 'dark blue',
      'verde': 'green', 'cinza': 'grey', 'branco': 'white'}

question = input('Digite uma cor em portugês: ')
...
print('A tradução dessa cor é', cor.get(question, 'Esta cor não consta no meu discionário.'))
